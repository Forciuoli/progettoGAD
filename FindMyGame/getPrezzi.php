...
{
	$table="<table>";
	$table.='<tr style="text-align:center"><td style="width:250px;"></td><td><img style="width:200px;height:80px" src="/gadProject/FindMyGame/images/product-details/amazonLogo.png"></td><td><img style="width:200px;height:80px" src="/gadProject/FindMyGame/images/product-details/ebayLogo.png"></td></tr>';
	$enter = false;
	while($row = $result -> fetch_assoc())
	{
		...
		{
			if($row["platform"] == "PS4")
				$table.='<tr><td><img style="width:200px;height:60px" src="/gadProject/FindMyGame/images/product-details/ps4.jpg"></td><td><a href='.$row["linkAmazon"].' style="color:green;font-size:16px;font-weight:700;">'.($row["priceAmazon"]==$ottocento?$avviso:($row["priceAmazon"].' €')).'</a></td><td><a href='.$row["linkEbay"].' style="color:green;font-size:16px;font-weight:700;">'.($row["priceEbay"]==$ottocento?$avviso:(str_replace('.', ',', $row["priceEbay"]).' €')).'</a></td></tr>';
				if($row["platform"] == "PS3")
...
else 
{
	...
	if(stripos($platforms,"ps4")!==false)
	{
		...
		$table.='<tr><td><img style="width:200px;height:60px" src="/gadProject/FindMyGame/images/product-details/ps4.jpg"></td><td><a href='.$prezzi[0]["PS4_link"].' style="color:green;font-size:16px;font-weight:700;">'.($prezzi[0]["PS4"]==$ottocento?$avviso:($prezzi[0]["PS4"].' €')).'</a></td><td><a href='.$prezzi[1]["PS4_link"].' style="color:green;font-size:16px;font-weight:700;">'.($prezzi[1]["PS4"]==$ottocento?$avviso:(str_replace('.', ',', $prezzi[1]["PS4"]).' €')).'</a></td></tr>';
	...
	if(stripos($platforms,"ps3")!==false)
	{
		...
		$table.='<tr><td><img style="width:200px;height:60px" src="/gadProject/FindMyGame/images/product-details/ps3.png"></td><td><a href='.$prezzi[0]["PS3_link"].' style="color:green;font-size:16px;font-weight:700;">'.($prezzi[0]["PS3"]==$ottocento?$avviso:($prezzi[0]["PS3"].' €')).'</a></td><td><a href='.$prezzi[1]["PS3_link"].' style="color:green;font-size:16px;font-weight:700;">'.($prezzi[1]["PS3"]==$ottocento?$avviso:(str_replace('.', ',', $prezzi[1]["PS3"]).' €')).'</a></td></tr>';
	...
	if(stripos($platforms,"xboxone")!==false)
	{
		...
		$table.='<tr><td><img style="width:200px;height:60px" src="/gadProject/FindMyGame/images/product-details/xboxone.png"></td><td><a href='.$prezzi[0]["XBOXONE_link"].' style="color:green;font-size:16px;font-weight:700;">'.($prezzi[0]["XBOXONE"]==$ottocento?$avviso:($prezzi[0]["XBOXONE"].' €')).'</a></td><td><a href='.$prezzi[1]["XBOXONE_link"].' style="color:green;font-size:16px;font-weight:700;">'.($prezzi[1]["XBOXONE"]==$ottocento?$avviso:(str_replace('.', ',', $prezzi[1]["XBOXONE"]).' €')).'</a></td></tr>';
	...
	if(stripos($platforms,"xbox360")!==false)
	{
		...
		$table.='<tr><td><img style="width:200px;height:60px" src="/gadProject/FindMyGame/images/product-details/xbox360.png"></td><td><a href='.$prezzi[0]["XBOX360_link"].' style="color:green;font-size:16px;font-weight:700;">'.($prezzi[0]["XBOX360"]==$ottocento?$avviso:($prezzi[0]["XBOX360"].' €')).'</a></td><td><a href='.$prezzi[1]["XBOX360_link"].' style="color:green;font-size:16px;font-weight:700;">'.($prezzi[1]["XBOX360"]==$ottocento?$avviso:(str_replace('.', ',', $prezzi[1]["XBOX360"]).' €')).'</a></td></tr>';
	...
	if(stripos($platforms,"pc")!==false)
	{
		...
		$table.='<tr><td><img style="width:200px;height:60px" src="/gadProject/FindMyGame/images/product-details/pc.jpg"></td><td><a href='.$prezzi[0]["PC_link"].' style="color:green;font-size:16px;font-weight:700;">'.($prezzi[0]["PC"]==$ottocento?$avviso:($prezzi[0]["PC"].' €')).'</a></td><td><a href='.$prezzi[1]["PC_link"].' style="color:green;font-size:16px;font-weight:700;">'.($prezzi[1]["PC"]==$ottocento?$avviso:(str_replace('.', ',', $prezzi[1]["PC"]).' €')).'</a></td></tr>';
